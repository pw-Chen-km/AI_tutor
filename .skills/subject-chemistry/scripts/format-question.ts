/**
 * Deterministic formatter — chemistry.
 */
...
const HEADING_LABELS = new Set([
  'Scenario', 'Given Data', 'Balanced Equation', 'Assumptions', 'Required',
  'Reaction Conditions', 'Question', 'Lab Data',
]);

const LIST_SECTIONS = new Set(['Given Data', 'Assumptions', 'Required']);
