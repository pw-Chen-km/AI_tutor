/**
 * Deterministic formatter — geography.
 */
...
const HEADING_LABELS = new Set([
  'Region', 'Map Description', 'Data', 'Phenomenon', 'Scale', 'Question',
  'Scenario', 'Required', 'Human-Environment Link',
]);

const LIST_SECTIONS = new Set(['Data', 'Required', 'Human-Environment Link']);
