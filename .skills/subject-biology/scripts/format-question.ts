/**
 * Deterministic formatter — biology.
 */
...
const HEADING_LABELS = new Set([
  'Scenario', 'Observation', 'Data', 'Experimental Setup', 'Question',
  'Terminology', 'Diagram Description', 'Required',
]);

const LIST_SECTIONS = new Set(['Observation', 'Data', 'Experimental Setup', 'Required']);
