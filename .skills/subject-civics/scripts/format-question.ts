/**
 * Deterministic formatter — civics / social studies.
 */
...
const HEADING_LABELS = new Set([
  'Scenario', 'Stakeholders', 'Institutional Context', 'Legal or Policy Framework',
  'Question', 'Decision Point', 'Required', 'Prompt', 'Requirements',
]);

const LIST_SECTIONS = new Set([
  'Stakeholders', 'Institutional Context', 'Legal or Policy Framework', 'Required', 'Requirements',
]);
